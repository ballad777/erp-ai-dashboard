...
export function AppShell({ active, children }: AppShellProps) {
  return (
    <div className="min-h-screen bg-canvas">
      <header className="app-header sticky top-0 z-40 border-b border-blue-100/80 bg-white/76 backdrop-blur-2xl">
        <div className="app-header-inner mx-auto flex max-w-[1600px] items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="app-nav hidden items-center gap-2 rounded-2xl border border-blue-100 bg-white/66 p-1 backdrop-blur-xl md:flex">
            {navItems.map((item) => {
